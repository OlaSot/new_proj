...
import { ConceptHeroSection } from "@/components/sections/ConeptHero/ConceptHeroSection";
import { CONCEPTS } from "@/components/sections/ConeptHero/data";
import { GalleryCarousel } from "@/components/sections/GalleryCarousel/GalleryCarousel";
import { FinishingOptionsBanner } from "@/components/sections/FinishingOptionsBanner/FinishingOptionsBanner";
import { MaterialsSection } from "@/components/sections/MaterialsSection/MaterialsSection";
import { InfoImageBlock } from "@/components/sections/InfoImageBlock/InfoImageBlock";
import { TwoHoverZonesBanner } from "@/components/sections/TwoHoverZonesBanner/TwoHoverZonesBanner";
import { RealizedCasesSection } from "@/components/sections/RealizedCasesSection/RealizedCasesSection";
import { CASES } from "@/components/sections/CasesCatalog/CasesCatalogSection";
    ...
    <main className="bg-white text-black">
      ...
      <SectionReveal delay={0.14}>
        <InfoImageBlock
          ...
          image={{ src: "/images/concept.jpg", alt: "Target audience interior" }}
        />
      </SectionReveal>
